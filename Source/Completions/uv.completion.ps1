<#
    .SYNOPSIS
        Registers uv (Python package manager) shell completion for PowerShell
    .LINK
...
if (Get-Command uv -ErrorAction SilentlyContinue) {
    ...
    Write-Verbose 'uv shell completion registered successfully.'
} else {
    Write-Debug 'uv command not found; skipping uv completion registration.'
}
