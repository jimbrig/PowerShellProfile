<#
    .SYNOPSIS
        Registers envio shell completion for PowerShell
    .LINK
...
if (Get-Command envio -ErrorAction SilentlyContinue) {
    ...
    Write-Verbose 'envio shell completion registered successfully.'
} else {
    Write-Debug 'envio command not found; skipping envio completion registration.'
}
