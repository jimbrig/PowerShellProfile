<#
    .SYNOPSIS
        Registers rclone shell completion for PowerShell
    .LINK
        https://rclone.org/commands/rclone_completion_powershell/
#>
...
if (Get-Command rclone -ErrorAction SilentlyContinue) {
    ...
    Write-Verbose 'rclone shell completion registered successfully.'
} else {
    Write-Debug 'rclone command not found; skipping rclone completion registration.'
}
