<#
    .SYNOPSIS
        Registers rustup shell completion for PowerShell
    .LINK
...
if (Get-Command rustup -ErrorAction SilentlyContinue) {
    ...
    Write-Verbose 'rustup shell completion registered successfully.'
} else {
    Write-Debug 'rustup command not found; skipping rustup completion registration.'
}
