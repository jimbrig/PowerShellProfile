<#
    .SYNOPSIS
        Registers ffsend shell completion for PowerShell
    .LINK
...
if (Get-Command ffsend -ErrorAction SilentlyContinue) {
    ...
    Write-Verbose 'ffsend shell completion registered successfully.'
} else {
    Write-Debug 'ffsend command not found; skipping ffsend completion registration.'
}
