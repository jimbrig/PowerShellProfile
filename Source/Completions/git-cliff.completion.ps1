<#
    .SYNOPSIS
        Registers git-cliff shell completion for PowerShell
    .LINK
        https://git-cliff.org/
#>
...
if (Get-Command git-cliff -ErrorAction SilentlyContinue) {
    ...
    Write-Verbose 'git-cliff shell completion registered successfully.'
} else {
    Write-Debug 'git-cliff command not found; skipping git-cliff completion registration.'
}
